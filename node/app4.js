...
const geckoIds = ['bitcoin','ethereum','polkadot','cardano','chainlink','celsius-degree-token','aave','vechain','crypto-com-chain','uniswap','matic-network',
'swipe','reserve-rights-token','bluzelle','the-graph','the-graph'];
