            ...
            CoinGeckoClient.coins.markets({per_page:[250],page:[2]}).then((markets2) => {
                ...
                CoinGeckoClient.simple.price({ids: geckoIds,vs_currencies: ['eur','usd'],}).then((prices) => {
                    db.query(sqlHoldings, function(err,result) {
                        ...
                        res.write("<table><tr><td><h2>Coin</h2></td><td>Profit</td><td>Price</td><td>Portfolio Value</td><td>Deposits</td><td>Deposit Percentage</td><td>Holdings</td></tr>");
                        for(i=0;i<geckoIds.length;i++) {
                            ...
                            if(!stablecoins.includes(coinName)) {
                                ...
                                res.write("<td>"+(myround(tempValue - deposits[i])).toString()+"</td></tr>");       //profit
                                ...
                                res.write("<td>"+holdings[i].toString()+"</td>");                                   //holdings
