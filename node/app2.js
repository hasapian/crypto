                    ...
                    db.query(sqlHoldings, function(err,result) {
                        ...
                        for(i=0;i<geckoIds.length;i++) {
                            ...
                            if(!stablecoins.includes(coinName)) {
                                res.write("\n"+coinName);
                                res.write("\nDeposits: "+(Math.round((deposits[i] + Number.EPSILON) * 100)).toString()+"<br>");
                                ...
                                values[i] = tempValue;
                                res.write("\nProfit: "+(Math.round(((tempValue - deposits[i]) + Number.EPSILON) * 100)).toString()+"<br>");
                                res.write("\n---------<br>");
                                ...
                                if(i==(geckoIds.length-1)) { 
                                    ...
                                    res.write("---------<br>");
                                    res.write("Total Holdings Value: "+Math.round(((sumOfPosessions + stableOrFiat) + Number.EPSILON) * 100)+"<br>");
                                    res.write("Total Deposits: "+Math.round((totalDeposits + Number.EPSILON) * 100)+"<br>");
                                    res.write("<b>P&L: "+Math.round((((sumOfPosessions + stableOrFiat) - totalDeposits) + Number.EPSILON) * 100)+"</b><br>");
                                    res.write("("+Math.round((stableOrFiat + Number.EPSILON) * 100)+" EURO in Fiat or Stablecoins)<br>");
